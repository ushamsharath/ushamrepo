...
class WelcomeScreenH extends StatelessWidget {
  const WelcomeScreenH({super.key, required String userType});
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const  Hospital(page: 'register')),
                          );
                        },
                        child: Padding(
